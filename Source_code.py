...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('WELCOME IN SECURE WORLD!')
...
wn.title("SECURITY IS JUST A MYTH! ")
...
headingLabel = Label(headingFrame1, text=" 'WELCOME IN SECURE WORLD!'", fg='grey19', font=('Courier',13,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)


label1 = Label(wn, text='Enter the Message', font=('Courier',10,'bold'))
label1.place(x=15,y=150)

msg = Entry(wn,textvariable=Message,width=35, font=('calibre',10,'bold'))
msg.place(x=200,y=150)

label2 = Label(wn, text='Enter the key', font=('Courier',10,'bold'))
label2.place(x=10,y=200)

InpKey = Entry(wn, textvariable=key,  width=35,font=('calibre',10,'bold'))
InpKey.place(x=200,y=200)

label3 = Label(wn, text='Choose the option: ', font=('Courier',10,'bold'))
label3.place(x=15,y=250)
...
ShowBtn = Button(wn,text="Show Message",bg='honeydew2', fg='Red',width=15,height=1,command=Result)
#ShowBtn['font'] = font.Font( size=12)
ShowBtn.place(x=180,y=400)

ResetBtn = Button(wn, text='Reset', bg='honeydew2', fg='Red', width=15,height=1,command=Reset)
#ResetBtn['font'] = font.Font( size=12)
ResetBtn.place(x=15,y=400)

QuitBtn = Button(wn, text='Exit', bg='old lace', fg='Red',width=15,height=1, command=wn.destroy)
